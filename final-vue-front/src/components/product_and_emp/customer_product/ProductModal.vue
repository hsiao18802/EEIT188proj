          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <table>
                      ...
                      <tr>
                          <td style="width: 150px;">商品簡介</td>
                          <td>{{ product.description }}</td>
                      </tr>
                      <tr>
                          <td style="width: 150px;">租用數量</td>
                          <td><input type="number" v-model="count" @input="doInput('count', $event)"></td>
                      </tr>
                  </table>
              </div>
              <div class="modal-footer">
                  <button type="button" class="btn btn-primary" @click="addCart" style="color: white !important;">加入購物車</button>
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="color: white !important;">關閉</button>
              </div>
          </div>
      </div>
  </div>
